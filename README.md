...
The projects in this repository utilize [Google Cloud](https://cloud.google.com/) for launching instances. Projects may be easily modified to run on other cloud platforms.
